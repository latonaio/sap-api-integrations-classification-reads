...
import (
	...
	sap_api_input_reader "sap-api-integrations-classification-reads/SAP_API_Input_Reader"
	"sap-api-integrations-classification-reads/config"
...
func main() {
	...
	inputSDC := fr.ReadSDC("./Inputs/SDC_Classification_Class_sample.json")
	...
	caller.AsyncGetClassification(
		inputSDC.Class.Class,
		accepter,
	)
}
